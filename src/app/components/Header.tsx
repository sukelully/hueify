...
export default function Header() {
  return (
    <header className="absolute top-0 left-0 z-10 flex w-full items-center justify-between gap-4 px-6 py-3 sm:px-32">
      <Link href="/">
      ...
      <nav className="hidden space-x-6 md:flex">
        <button
          className="sign-in-btn hover:bg-black-hover dark:hover:bg-white-hover cursor-pointer rounded-lg bg-black px-3 py-1 font-semibold text-white dark:bg-white dark:text-black"
          onClick={signIn}
        >
          Sign in
        </button>
